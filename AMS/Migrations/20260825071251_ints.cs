    ...
    public partial class ints : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvocateSchedule", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdvocateSchedule_Advocate_AdvocateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskManagement_Advocate_AdvocateId",
                        column: x => x.AdvocateId,
                        principalTable: "Advocate",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_Advocate_AdvocateId",
                        column: x => x.AdvocateId,
                        principalTable: "Advocate",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Case_Advocate_AdvocateId",
                        column: x => x.AdvocateId,
                        principalTable: "Advocate",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LegalNotice_Client_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Client",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advocate_Email",
                table: "Advocate",
                column: "Email",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Advocate_LicenseNumber",
                table: "Advocate",
                column: "LicenseNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AdvocateSchedule_AdvocateId_ScheduleDate",
                table: "AdvocateSchedule",
                columns: new[] { "AdvocateId", "ScheduleDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LegalNotice_ClientId",
                table: "LegalNotice",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Payment_CaseId",
                table: "Payment",
                column: "CaseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskManagement_AdvocateId",
